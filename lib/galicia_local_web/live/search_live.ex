  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-base-100">
      <div class="container mx-auto max-w-6xl px-4 py-8">
        <!-- Header -->
        <div class="mb-8">
          <h1 class="text-3xl font-bold text-base-content mb-2">Search Businesses</h1>
          <p class="text-base-content/60">
            Find services and businesses across Galicia
          </p>
        </div>
        ...
        <div class="mb-4 flex justify-between items-center">
          <span class="text-sm text-base-content/60">
            ...
            <%= if @english_only do %>
              <span class="badge badge-success badge-sm ml-2">English speaking</span>
            <% end %>
            <%= if @local_gems do %>
              <span class="badge badge-warning badge-sm ml-2">Local Gems</span>
            <% end %>
          </span>
        </div>

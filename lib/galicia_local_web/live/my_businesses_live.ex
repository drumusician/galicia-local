defmodule GaliciaLocalWeb.MyBusinessesLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     socket
     |> assign(:page_title, "My Businesses")
    ...
    <div class="min-h-screen bg-base-200">
      <div class="container mx-auto max-w-4xl px-4 py-8">
        ...
        <% else %>
          <div class="card bg-base-100 shadow mb-8">
            <div class="card-body text-center py-12">
              ...
              <p class="text-base-content/50 mt-2">You don't own any businesses yet.</p>
              <p class="text-sm text-base-content/40">Find your business and claim it to start managing your listing.</p>
        ...
        <%= if length(@pending_claims) > 0 do %>
          <h2 class="text-xl font-bold mb-4">Your Claims</h2>
          <div class="space-y-3">

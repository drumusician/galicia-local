defmodule GaliciaLocal.Repo.Migrations.PopulateRegionSettings do
  ...
  def up do
    ...
    execute """
    UPDATE regions
    SET tagline = 'Celtic heritage, incredible seafood, warm communities',
        hero_image_url = 'https://images.unsplash.com/photo-1684931772184-75c6fb13c1f9?w=1920&q=80',
        settings = '#{galicia_settings}'::jsonb
    WHERE slug = 'galicia'
    """
    ...
    execute """
    UPDATE regions
    SET tagline = 'Cycling culture, canals, welcoming expat scene',
        hero_image_url = 'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=1920&q=80',
        settings = '#{netherlands_settings}'::jsonb

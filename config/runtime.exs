...
#
#     PHX_SERVER=true bin/galicia_local start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :galicia_local, GaliciaLocalWeb.Endpoint, server: true
end

if config_env() != :worker do
...
if config_env() in [:prod, :worker] do
  ...
  config :galicia_local, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :galicia_local, GaliciaLocal.Mailer,
